...
Shadowsocks（以下简称ss）搭建教程，参考https://github.com/zhaoweih/Shadowsocks-Tutorial

# 开始

## 购买VPS服务器

俗话说，万事开头难。其实搭建过程一点都不难，也不是说购买VPS服务器有多难，主要是对于广大学生来说接受它比较难，作为一个还没买过服务器的小白，对于第一次尝试的东西都没有底，怎么敢随意下手。好了，你现在可以放心了，据我所知，Vultr和DigitalOcean这两个服务商都是可以随时部署随时摧毁服务器，是按每小时计费的，一个月是5美金，大概0.007美金一小时，就算你创建一个服务器IP刚好是被某墙屏蔽了，删掉重新再选一个也只是扣0.01美金，真的很便宜很便宜，想想墙外世界的精彩，不要犹豫了！！！

### 1、注册并登录

Vultr推荐链接：https://www.vultr.com/?ref=7370522

这里比较推荐Vultr，为什么呢？因为他有日本服务器，延迟低，掉包也低；注册账户后需要进行**邮箱验证**，接着用支付宝或者微信支付对账户充值

![image](https://github.com/YanZehong/sthUseful/blob/master/images/1.png)

### 2、部署服务器

第一步：在个人页面点击Servers然后再点右面的➕号按钮添加一个服务器

![image](https://github.com/YanZehong/sthUseful/blob/master/images/2.png)

第二步：在打开的页面选择Tokyo日本服务器，如果喜欢其他服务器也可以选择，后续操作是一样一样的

![image](https://github.com/YanZehong/sthUseful/blob/master/images/3.png)

第三步：接下来要注意了，系统最好选择CentOS 6，点击CentOS可以下拉选择6

![image](https://github.com/YanZehong/sthUseful/blob/master/images/4.png)

第四步：选择套餐，当然ss不需要配置太高的服务器，最低配置5美金一个月的就可以了(据说会有2.5美金的情况出现，如果你能看到那赶紧选啊，千年一遇)

![image](https://github.com/YanZehong/sthUseful/blob/master/images/5.png)

第五步：接着就是部署起来了，当然你也可以给服务器起个名字再部署

![image](https://github.com/YanZehong/sthUseful/blob/master/images/6.png)

第六步：接着等待服务器启动完成，看到Status是绿色的Running就是启动完成了，这个过程大概需要1-3分钟。

![image](https://github.com/YanZehong/sthUseful/blob/master/images/7.png)

第七步：点一下启动完成的服务器，然后复制IP地址和密码，后面有用
![image](https://github.com/YanZehong/sthUseful/blob/master/images/9.png)

![image](https://github.com/YanZehong/sthUseful/blob/master/images/8.png)
...
![image](https://github.com/YanZehong/sthUseful/blob/master/images/10.png)
...
IOS: 
由于国区APP下架VPN类APP，包括支持ss类的APP，所以需要切换账号。这里建议注册一个国外账号，不要国内账号换区，这样既可以需要下载国内APP时切换国区账号，需要下载国外APP时切换外区账号。
...
- 这里简要说一下PAC(Proxy Auto Configure)模式和Global全局模式问题：
...
接着最神圣的时刻来了，在浏览器输入google.com，回车，谷歌回来了

![](./images/w-16.png)

# Preferences
### 加速
这里我们的任务完成了，但是如果你想优化一下服务器连接，可以安装BBR加速。具体可以看这篇文章：[文章](https://teddysun.com/489.html)
